  ...
  return (
    <main className="flex min-h-screen flex-col items-center justify-center bg-background px-5 text-center">
      <div className="animate-fade-in">
        ...
        <Link
          href="/"
          className="mt-8 inline-flex items-center gap-2 rounded-full bg-accent px-6 py-3 text-sm font-bold text-ink transition-all duration-300 hover:bg-accent-strong hover:shadow-lg hover:shadow-accent/30"
        >
          <span className="transition-transform duration-300">&larr;</span>
          Back to home
        </Link>
      </div>
    </main>
